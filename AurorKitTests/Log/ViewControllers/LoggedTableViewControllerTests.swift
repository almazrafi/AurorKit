//
//  LoggedTableViewControllerTests.swift
//  AurorKit
//
...
class LoggedTableViewControllerTests: QuickSpec {
    ...
    override func spec() {
        ...
        context("when it is initialized") {
            var viewController: LoggedTableViewController!

            beforeSuite {
                viewController = LoggedTableViewController()
            }
