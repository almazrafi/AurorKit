//
//  LoggedNavigationControllerTests.swift
//  AurorKit
//
...
class LoggedNavigationControllerTests: QuickSpec {
    ...
    override func spec() {
        ...
        context("when it is initialized") {
            var viewController: LoggedNavigationController!

            beforeSuite {
                viewController = LoggedNavigationController()
            }
