//
//  LoggedPageViewControllerTests.swift
//  AurorKit
//
...
class LoggedPageViewControllerTests: QuickSpec {
    ...
    override func spec() {
        ...
        context("when it is initialized") {
            var viewController: LoggedPageViewController!

            beforeSuite {
                viewController = LoggedPageViewController()
            }
